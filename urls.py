...
urlpatterns = [
    ...
    path('datkham2/<int:id>/<str:time>/', views.booking, name="datkham1"),
    path('book_appointment', views.book_appointment, name="book_appointment"),
    path('book_appointment1', views.book_appointment1, name="book_appointment1"),
    path('success', views.success, name="success"),
    #code tìm kiếm bác sĩ
    path('test-info/', views.thongtinBS, name="thongtinBS"),
    path('get-time-available/', views.get_time_available, name="get_time_available")
    ]
